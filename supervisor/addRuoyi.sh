...
[program:ruoyi-auth]
directory=${RUOYI}
command=/usr/local/java/bin/java -jar ruoyi-auth/target/ruoyi-auth-2.4.0.jar
autostart=true
autorestart=true
startsecs=5
startretries=3
...
directory=${RUOYI}
command=/usr/local/java/bin/java -jar ruoyi-gateway/target/ruoyi-gateway-2.4.0.jar
autostart=true
autorestart=true
startsecs=5
startretries=3
...
directory=${RUOYI}
command=/usr/local/java/bin/java -jar ruoyi-modules/ruoyi-system/target/ruoyi-modules-system-2.4.0.jar
autostart=true
autorestart=true
startsecs=5
startretries=3
